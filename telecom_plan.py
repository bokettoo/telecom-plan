...
while True:
    ...
    if choice == "1":
        minutes_talked = int(input("Enter the communication duration in minutes: "))

    elif choice == "2":
        prices = total_price(minutes_talked)
